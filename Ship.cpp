...
namespace Engine
{
	...
	void Ship::ChangeShip()
	{
		...
		m_points.push_back(Math::Vector2(4,17));
		m_points.push_back(Math::Vector2(-4, 17));
		m_points.push_back(Math::Vector2(5, 14));
		m_points.push_back(Math::Vector2(-5,14));
		m_points.push_back(Math::Vector2(5, 10));
		m_points.push_back(Math::Vector2(-5, 10));
		m_points.push_back(Math::Vector2(5, 7));
		m_points.push_back(Math::Vector2(-5, 7));
		m_points.push_back(Math::Vector2(5, 1));
		m_points.push_back(Math::Vector2(-5, 1));
		m_points.push_back(Math::Vector2(7, -3));
		m_points.push_back(Math::Vector2(-7, -3));
		m_points.push_back(Math::Vector2(2, -2));
		m_points.push_back(Math::Vector2(-2, -2));
		m_points.push_back(Math::Vector2(0, 0));
